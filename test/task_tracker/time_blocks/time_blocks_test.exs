defmodule TaskTracker.TimeBlocksTest do
  ...
  describe "time_blocks" do
    ...
    @valid_attrs %{end_time: "2010-04-17T14:00:00Z", in_progress: true, start_time: "2010-04-17T14:00:00Z"}
    @update_attrs %{end_time: "2011-05-18T15:01:01Z", in_progress: false, start_time: "2011-05-18T15:01:01Z"}
    @invalid_attrs %{end_time: nil, in_progress: nil, start_time: nil}
    ...
    test "create_time_block/1 with valid data creates a time_block" do
      ...
      assert time_block.in_progress == true
    ...
    test "update_time_block/2 with valid data updates the time_block" do
      ...
      assert time_block.in_progress == false
